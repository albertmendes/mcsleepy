...
<div class="container fade-opacity">
  ...
  <div class="zimmer-gray-stripe">
    <ul class="zimmer-social-icons">
      <li><a href="whatsapp://send?text=https://mcsleepy.de/Drogba">p</a></li>
      <li>
        <div class="custom-fb-wohnung">
          <a class="fblike-icon" href="#">r</a>
          <span>
            <div class="fb-share-button" data-href="https://mcsleepy.de/Drogba" data-layout="button" data-size="small" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmcsleepy.de%2FDrogba&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
          </span>
        </div>
      </li>
      ...
      <li>
        <div class="custom-gplus-wohnung">
          ...
          <span>
            <div class="g-plus" data-action="share" data-href="https://mcsleepy.de/Drogba"></div>
          </span>
        </div>
      </li>
      <li>
        <div class="custom-twitter-wohnung">
          ...
          <span>
            <a href="https://twitter.com/share?ref_src=twsrc%5Etfw" class="twitter-share-button" data-url="https://mcsleepy.de/Drogba" data-hashtags="Monteurzimmer" data-show-count="false">Tweet</a><script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
          </span>
        </div>
      </li>
    </ul>
