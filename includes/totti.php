...
<div class="container fade-opacity">
  ...
  <div class="zimmer-gray-stripe">
    <ul class="zimmer-social-icons">
      <li><a href="whatsapp://send?text=https://mcsleepy.de/Totti">p</a></li>
      <li>
        <div class="custom-fb-wohnung">
          <a class="fblike-icon" href="#">r</a>
          <span style="opacity: 0.001 !important">
            <div class="fb-share-button" data-href="https://mcsleepy.de/Totti" data-layout="button" data-size="small" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fmcsleepy.de%2FTotti&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Share</a></div>
          </span>
        </div>
      </li>
      ...
      <li>
        <div class="custom-gplus-wohnung">
          ...
          <span>
            <div class="g-plus" data-action="share" data-href="https://mcsleepy.de/Totti"></div>
          </span>
        </div>
      </li>
      <li>
